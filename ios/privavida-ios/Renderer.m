...
-(nonnull instancetype)initWithMetalKitView:(nonnull MTKView *)view andAppText:(AppText)app_text {
    self = [super init];
    if (!self) {
        return self;
    }
    ...
    app_init(_vg, app_text, storage, [[Networking sharedInstance] appNetworking]);
