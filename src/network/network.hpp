...
void relay_add_task_request(RelayId relay_id, const Filters* filters);
void relay_add_task_stream(RelayId relay_id,  const Filters* filters);
void relay_add_task_publish(RelayId relay_id, const Event* event);
void stop_all_tasks();
